...
function MailAccountCard({ account, workspaces, onSave, onSync, busy }) {
  ...
  useEffect(() => setDraft({ mail_enabled: Boolean(account.mail_enabled), mail_destinations: account.mail_destinations || [], pm_workspace_ids: account.pm_workspace_ids || [], mail_categories: account.mail_categories || mailCategories.map(([v]) => v) }), [account.id, account.updated_at]);
