      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            {p1 ? (
              <span className="text-[11px] font-black px-2 py-1 rounded-full bg-red-500/20 border border-red-500/40 text-red-100 shadow-[0_0_14px_rgba(239,68,68,0.22)]">
                SERVICE NOW
              </span>
            ) : null}
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          ...
          <Row
            label="Category"
            value={ticket?.category_name || ticket?.category_path || "—"}
          />
          <Row label="ZIP" value={ticket?.service_zip || "—"} />
          <Row
            label="Routing"
            value={ticket?.is_marketplace ? "Marketplace" : "Direct"}
          />

          <div
            className={cx(
              "rounded-2xl border bg-slate-950/30 p-3",
              p1 ? "border-red-500/40 bg-red-500/10" : "border-slate-800"
            )}
          >
      ...
      {!isCustomer ? (
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-950/40 p-5">
          ...
          <div className="mt-3 space-y-2 text-sm text-slate-300">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-950/30 p-3">
              When the business sends a final invoice, it will appear in the
              Invoice tab.
            </div>
          </div>
        </div>
