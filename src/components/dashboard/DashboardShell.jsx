...
export default function DashboardShell({
  ...
  return (
    <div className="min-h-dvh overflow-x-hidden bg-[#020617] text-slate-100" data-sw-shell="dashboard">
      ...
      <div className="md:hidden" data-sw-layout="portrait">
