...
export default function GlobalModeBar() {
  ...
  return (
    <>
      ...
      <div ref={rootRef} className="fixed inset-x-0 top-0 z-[120] border-b border-cyan-400/15 bg-[#020617]/98 px-3 py-2 shadow-[0_10px_30px_rgba(0,0,0,0.38)] backdrop-blur-xl">
