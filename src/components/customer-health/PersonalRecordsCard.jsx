  ...
  return (
    <section className="rounded-[1.5rem] border border-fuchsia-300/20 bg-[linear-gradient(135deg,rgba(255,59,212,0.08),rgba(139,92,246,0.07))] p-3 sm:rounded-[2rem] sm:p-4">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="rounded-xl border border-fuchsia-300/20 bg-fuchsia-300/10 px-2.5 py-1.5 text-[10px] font-black text-fuchsia-100">
          {result.records.length
            ? `${result.records.length} PR${result.records.length === 1 ? "" : "s"}`
            : "Tracking"}
        </div>
      </div>
